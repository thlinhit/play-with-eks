...
```bash
AWS_PROFILE=acloudguru2 aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 332954233786.dkr.ecr.us-east-1.amazonaws.com/myapp
```

```bash
docker tag myapi:0.0.1 332954233786.dkr.ecr.us-east-1.amazonaws.com/myapp:0.0.1
```

```bash
docker push 332954233786.dkr.ecr.us-east-1.amazonaws.com/myapp:0.0.1
```
